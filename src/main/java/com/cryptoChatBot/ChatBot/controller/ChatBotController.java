...
public class ChatBotController {
    ...
    @PostMapping("/simple")
    public ResponseEntity<String> simpleChatHandler(@RequestBody prompt promptBody) throws Exception {
        String response= chatbotService.simpleChat(promptBody.getPromptBody());
